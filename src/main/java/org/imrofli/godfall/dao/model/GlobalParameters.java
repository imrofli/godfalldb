...
@Entity
public class GlobalParameters extends AbstractEntity {
    ...
    private Rarity ascendedItemMinRarityIdentifier;
    ...
    public Rarity getAscendedItemMinRarityIdentifier() {
        return ascendedItemMinRarityIdentifier;
    }

    public void setAscendedItemMinRarityIdentifier(Rarity ascendedItemMinRarityIdentifier) {
