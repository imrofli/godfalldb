...
public class AmuletDetailView extends VerticalLayout {
    ...
    public AmuletDetailView(TrinketService trinketService, LootInfoService lootInfoService, ItemScalingService itemScalingService) {
