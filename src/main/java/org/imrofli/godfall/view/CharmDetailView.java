...
public class CharmDetailView extends VerticalLayout {
    ...
    public CharmDetailView(TrinketService trinketService, LootInfoService lootInfoService, ItemScalingService itemScalingService) {
